...
# Rodar a verificação direcionada relevante em supabase/tests/ quando houver
# Se existir teste JS específico no escopo, rodar só o arquivo relevante
```

Ler story na smart-memory, verificar cada AC contra o código, aplicar checklist de 8 pontos e validar pelo menor conjunto de checks reais disponível no repo.
